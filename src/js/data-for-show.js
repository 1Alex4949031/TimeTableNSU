...
export const constraint = ref([
    ...
    'Запрещенный порядковый номер пары для преподавателя в определённый день',
    'Запрещенные порядковый номер пары для групп в определённый день',
    'Запрещенный день для преподавания для преподавателя',
    'Запрещенный день для преподавания для группы',
    'Недопустимые пересечения групп',
    'Недопустимые пересечения учителей',
    'Обязательное время пары'
])
